<template>
  <div id="app">
    <a class="button" @click="previous" v-link="{ name: 'page', params: { pageNum: page} }">GO PREVIOUS<span>CURRENT:{{page}}</span></a>
    <list :page="page" :trigger.sync="finish"></list>
    <a class="button" @click="next" v-link="{ name: 'page', params: { pageNum: page} }">GO NEXT<span>CURRENT:{{page}}</span></a>
